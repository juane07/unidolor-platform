    ...
    if (fieldsValue) {
      ...
      if (fieldsValue.items) {
        ...
        fieldsValue.items.map((item) => {
          const { quantity, price, itemName, description, service, cupsCode, simonLevel } = item;
          const total = item.quantity * item.price;
          newList.push({ total, quantity, price, itemName, description, service, cupsCode, simonLevel });
        });
