const lang = {
  ...
  estado_fiscal: 'Fiscal Status',
  anular: 'Void',
  anular_factura: 'Void Invoice',
  anular_factura_message: 'A credit note reversing the total will be issued automatically (RN-023). Continue?',
  tax_total: 'Tax Total',
