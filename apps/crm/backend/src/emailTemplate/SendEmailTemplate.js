exports.SendInvoice = ({ title = 'Invoice from Alegro X', name = '', time = new Date() }) => {
  return `
    <div>
...
exports.SendQuote = ({ title = 'Quote from Alegro X', name = '', time = new Date() }) => {
  return `
    <div>
...
exports.SendOffer = ({ title = 'Offer from Alegro X', name = '', time = new Date() }) => {
  return `
    <div>
...
exports.SendPaymentReceipt = ({
  title = 'Payment Receipt from Alegro X',
  name = '',
  time = new Date(),
}) => {
  return `
